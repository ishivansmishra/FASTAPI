...
@app.get('/sort')
def sort_patients(sort_by: str=Query(..., description='Sort on the basics of the height,weight or bmi'),order: str=Query('asc',description='sort in asc or desc order')):
...
def delete_patient(patient_id: str):
    ...
    return JSONResponse(status_code=200,content={'messge':"Patient is deleted"})
